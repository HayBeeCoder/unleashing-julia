...
# ╔═╡ 870a1704-6f98-4fdd-9a00-bed4a6595915
begin
	using DataFrames
	using CSV
end

# ╔═╡ fd8adc2a-aaae-404b-bc28-68a95bb9e52d

using Plots  # This will install plots

# ╔═╡ 088fd5d0-ba37-4d5d-bb06-21bb7f6c5e9a
using PlutoUI


# ╔═╡ 813558cb-ceab-4dd0-a5c6-add7e761adf8
df = CSV.read("WHO-COVID-19-global-data.csv", DataFrame)


# ╔═╡ 3e7b27d2-b8c0-4dc3-8d8a-fa65efe5cca6
df.Country_code === df[!, "Country_code"]


# ╔═╡ 3786a63d-a77b-4423-993f-be0020be6e72
equals_sg(x::AbstractString) = x == "SG"

# ╔═╡ 508187b7-6253-4189-9c4d-d1ae8abb0f99
sg_data = filter(:Country_code => equals_sg, df)


# ╔═╡ 144973c9-d14d-491e-878a-00f27d049f9f
dates = sg_data[!, "Date_reported"]


# ╔═╡ 841c178c-9fae-48cd-a9b5-7a7af22dfde9

cumulative_cases = sg_data[!, "Cumulative_cases"]

# ╔═╡ c894462d-d5c3-48f0-b2a6-3c9449526dc6
cumulative_data_plotted_over_date = plot(dates, cumulative_cases)

# ╔═╡ b4ffa832-63ab-4a55-9750-c12d502ae0fd
...
# ╔═╡ 755219d9-a5d8-4b33-ba17-a455580ac0d1
@bind slider_value Slider(0:10:1000)


# ╔═╡ 25fdec7b-827f-4f96-93f5-8eb66dbd6ca3
md"""
### Slider Value Now At $(slider_value)
"""

# ╔═╡ afae6ea4-19b6-4150-bc19-265e425e9549
@bind date_slider_index Slider(1:length(dates))


# ╔═╡ d4d52e34-9729-43cb-a36e-91b6114868f6
md"""
### The date is now $(dates[date_slider_index])
"""

# ╔═╡ caccd2ad-5a74-4052-9c5b-4d38b288b567
...
# ╔═╡ 35180663-a8d8-4643-9a68-e4cdc79700e8


# ╔═╡ 25b8c784-5019-41b4-afe3-a0ae50c855ad
